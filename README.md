...
- **Tests (`tests.yml`):** Builds the project PHP 8.5 container, installs dependencies inside it, builds assets, and runs PHPUnit to guard core flows like authentication and finance operations.
...
- **Static analysis (`static-analysis.yml`):** Executes PHPStan and a Rector dry run inside the project container to catch type and refactoring issues early.
